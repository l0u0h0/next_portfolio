        ...
        <div className="w-full flex flex-col mx-6 md:mr-6 text-center md:text-left items-start">
          ...
          <div className="flex flex-wrap md:flex-nowrap">
            <div className="m-10 ml-0">
              ...
              <li>
            저는 서비스 <b>최적화</b>를 위해 <b>고민하고 노력하는 개발자</b>를 목표로 나아가고 있습니다.
          </li>
                <li>
                팀 구성원들과의 <b>커뮤니케이션</b>을 중요시하며 <b>모르는 것</b>을 해결할 때, <b>새로운 것</b>을 배워나갈 때 <b>즐거움</b>을 느끼는 주니어 개발자입니다.
                </li>
                <li>
                <b>React</b>를 활용한 <b>웹 프론트엔드 개발</b>을 주로 하였고 <b>반응형 디자인</b>을 통한 웹앱 프로젝트 진행 경험이 있습니다. 최근엔 <b>웹 성능 최적화</b>나 <b>웹 접근성</b>을 고려한 개발에 관심을 가지고 있습니다.
                </li>
                <li>
                현재 <b>삼성 청년 SW 아카데미</b>에서 알고리즘에 기반한 <b>웹개발 교육 과정</b>을 자바 전공자 반으로 수료 중에 있습니다. 이 과정에서 <b>팀 프로젝트</b>를 경험하며 <b>Slack</b>, <b>Jira</b>, <b>Gitlab</b> 등 협업 툴에 대한 경험이 있습니다.
                </li>
              </ul>
            </div>
          </div>
