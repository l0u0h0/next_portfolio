...
export default function Content() {
  return (
    <>
        ...
        <div className="flex flex-col py-5">
          <ul className="mx-5 leading-relaxed text-lg text-start">
            <li className="flex items-center my-3">
              ...
              <b className="text-2xl font-jalnan">React</b>
            </li>
          ...
          <ul className="mx-5 leading-relaxed text-lg text-start">
            <li className="flex items-center my-3">
              ...
              <b className="text-2xl font-jalnan">Javascript</b>
            </li>
            <li className="ml-4 list-disc">
            ...
            <li className="flex items-center my-3">
              ...
              <b className="text-2xl font-jalnan">Typescript</b>
            </li>
            <li className="ml-4 list-disc">
          ...
          <ul className="mx-5 leading-relaxed text-lg text-start">
            <li className="flex items-center my-3">
              ...
              <b className="text-2xl font-jalnan">Redux</b>
            </li>
            <li className="ml-4 list-disc">
          ...
          <ul className="mx-5 mb-6 leading-relaxed text-lg text-start">
            <li className="flex items-center my-3">
              ...
              <b className="text-2xl font-jalnan">Recoil</b>
              <img className="w-8 h-8 mx-2" src="https://storage.googleapis.com/candycode/jotai/jotai-mascot.png" alt="Jotai" />
              <b className="text-2xl font-jalnan">Jotai</b>
            </li>
            <li className="ml-4 list-disc">
            그동안 중앙 집중 식의 <b>Flux 패턴</b>을 통한 상태 관리 라이브러리인 Redux만 사용해보다가 <b>Atom 패턴</b>의 상태 관리 라이브러리인 <b>Recoil</b>을 학습. <b>useState</b>와 비슷한 구조로 친숙하게 사용.
            </li>
            <li className="ml-4 list-disc">
      ...
      <div className="w-full flex flex-col mx-6 md:mr-6 text-center md:text-left items-start">
        <div className="w-full title-font text-start">
          <h1 className="text-2xl sm:text-3xl">🏆 Others</h1>
          <hr className="min-w-[246px] mt-4 border-2 dark:border-1 border-zinc-900 dark:border-zinc-300" />
        </div>
        <div className="flex flex-wrap md:flex-nowrap">
          <div className="m-10 mx-0">
            <ul className="mb-8 ml-12 mr-6 leading-relaxed text-lg text-left list-disc">
              <li>
              <small>2023.08.18</small> - <b>삼성 청년 SW 아카데미</b>(SSAFY) 공통프로젝트(트랙: 웹기술) <b>우수상</b> 수상
              </li>
              <li>
              <small>2020.11.13</small> - 2020 STARTUP INVENTION CONTEST 공모전 <b>단체상</b> 수상
              </li>
              <li>
              <small>2017.11.11</small> - 마이스타일 트렌드페어 2017 대학생 STARTUP 공모전 <b>장려상</b> 수상
              </li>
            </ul>
          </div>
        </div>
